...
export default function RedesComp() {
  return (
    <div id="redes" className="pt-[80px] lg:pt-[120px] text-center px-4">
      ...
      >
        {/* INSTAGRAM */}
        <div className="group flex justify-center items-center gap-[16px] cursor-pointer">
          <Image
            ...
            alt="Instagram"
            unoptimized
            className="transition-all duration-300 group-hover:drop-shadow-[0_0_15px_rgba(241,236,22,0.8)]"
          />

          <p className="text-white text-start font-extralight text-[16px] transition-colors duration-300 group-hover:text-[#F1EC16]">
            Instagram
          </p>
        </div>
